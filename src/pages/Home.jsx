...
/* ================================================================
   GOLD SPARKLE -- CSS-only floating particles
   ================================================================ */
    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      >
        ...
        <div className="overflow-hidden">
          {["PRECISION", "CRAFT", "FACTORY FINISH."].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
        ...
        >
          ...
          <p className="text-white/30 text-xs sm:text-sm uppercase tracking-[0.2em]" style={{ fontFamily: 'var(--font-sans)' }}>
            {hero.trustBadge} &middot; 40 Craster Rd &middot; Est. 2015
          </p>
        </motion.div>
      ...
      <div className="hidden lg:flex absolute right-8 bottom-12 z-20">
        ...
        >
          Pro Auto Body Shop &mdash; Harare, Zimbabwe
        </span>
      </div>
    </section>
  );
...
function MarqueeTicker() {
  const items = ["PANEL BEATING", "SPRAY PAINTING", "ACCIDENT REPAIR", "DETAILING", "MECHANICAL", "CUSTOM WORK"];
...
function ServicesGrid() {
  ...
  const serviceImages = ['https://images.unsplash.com/photo-1487754180451-c456f719a1fc?w=800&q=80', 'https://images.unsplash.com/photo-1580273916550-e323be2ae537?w=800&q=80', 'https://images.unsplash.com/photo-1487754180451-c456f719a1fc?w=800&q=80', 'https://images.unsplash.com/photo-1580273916550-e323be2ae537?w=800&q=80', 'https://images.unsplash.com/photo-1487754180451-c456f719a1fc?w=800&q=80', 'https://images.unsplash.com/photo-1580273916550-e323be2ae537?w=800&q=80'];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-white/50 text-sm sm:text-base leading-relaxed mb-6 max-w-lg" style={{ fontFamily: 'var(--font-sans)' }}>
              Founded with a singular mission: to deliver the highest quality panel beaters services in Zimbabwe. What began as a small operation has grown into one of Harare's most trusted names.
            </p>
            <p className="text-white/35 text-sm leading-relaxed max-w-lg" style={{ fontFamily: 'var(--font-sans)' }}>
              Today, with a team of experienced professionals and 17+ satisfied clients, our track record speaks for itself. We bring the same meticulous attention to detail to every single project.
            </p>
            ...
            <div className="flex gap-10 sm:gap-16">
              <div>
                <div className="text-gold-500 font-heading text-3xl sm:text-4xl italic leading-none">2015</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Founded</div>
              </div>
              <div>
                <div className="text-gold-500 font-heading text-3xl sm:text-4xl italic leading-none">17+</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Clients</div>
              </div>
              <div>
                <div className="text-gold-500 font-heading text-3xl sm:text-4xl italic leading-none">4.2</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Rating</div>
              </div>
            </div>
          </motion.div>
            ...
            <div className="relative">
              <div className="overflow-hidden">
                <img
                  ...
                  alt="Pro Auto Body Shop professional work"
              ...
              <div className="absolute -bottom-8 -left-6 sm:-left-10 w-[45%] overflow-hidden border-4 border-navy-950 shadow-2xl">
                <img
                  ...
                  alt="Pro Auto Body Shop detail work"
...
function WhyChooseUs() {
  ...
  const points = [{"title": "Proven Track Record", "desc": "Rated 4.2 stars with 17+ verified reviews from satisfied clients across Harare."}, {"title": "Expert Team", "desc": "Our experienced professionals bring years of specialised knowledge and continuous training to every project."}, {"title": "Transparent Pricing", "desc": "No hidden costs, no surprises. We provide detailed quotes upfront so you know exactly what to expect."}, {"title": "Quality Guarantee", "desc": "We stand behind our work with a satisfaction guarantee. If you are not happy, we make it right."}];
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            <img
              src="https://images.unsplash.com/photo-1580273916550-e323be2ae537?w=800&q=80"
              alt="Pro Auto Body Shop quality work"
              className="w-full aspect-[4/5] object-cover object-center"
              loading="lazy"
            />
          ...
          >
            ...
            <h2 className="font-heading text-white leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-gold-500">Pro</span>
            </h2>
    ...
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img
          ...
          alt="Pro Auto Body Shop services"
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a
              ...
              className="group inline-flex items-center gap-3 border border-green-500/40 text-green-400 px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-500 hover:bg-green-500/10 hover:border-green-500/60"
              style={{ fontFamily: 'var(--font-sans)' }}
            >
